...
---------------------
  ...
  3. Select "Deploy from GitHub repo" and choose Ether.ai
  4. Add a MongoDB database service (click + New -> Database -> MongoDB)
  5. Set environment variables on the app service:
       MONGO_URI   = (copy from MongoDB service's MONGO_URL variable)
       JWT_SECRET  = ethara_super_secret_key_change_in_production
       JWT_EXPIRE  = 7d
       NODE_ENV    = production
  6. Go to Settings -> Networking -> Generate Domain
  7. Your app is now live at the generated URL
